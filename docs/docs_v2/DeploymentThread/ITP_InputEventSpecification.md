...
has_children: true
nav_order: 1
permalink: /docs/v2_0_0/DeploymentStages/ITP/HostEvents
---
...
{: .note }
> Edit the [`Config_HostEvents.h` file]({{ site.baseurl }}/docs/v2_0_0DeploymentThreads/Config_HostEvents) to specify the information required from the host.
...
use this event. (See [Plugin Basics]({{ site.baseurl }}/docs/v2_0_0PluginBasics/#processor) chapter if you are not familiar with the concept of buffer)
